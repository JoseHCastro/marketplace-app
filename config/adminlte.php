...
return [
    ...
    */
    ...
    'logo_img' => 'vendor/adminlte/dist/img/MarketplaceLogo.png',
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => true,
        'img' => [
            'path' => 'vendor/adminlte/dist/img/MarketplaceLogo.png',
            'alt' => 'Marketplace',
            'class' => '',
            'width' => 50,
            'height' => 50,
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'can' => 'ver listado de roles de usuario',
                    'icon' => 'fas fa-check-square',
                    'route' => 'asignar.index',
                ...
                [
                    ...
                    'submenu' => [
                        [
                            'text' => 'Backups',
                            'can' => 'ver listado backup',
                            'icon' => 'fas fa-check-square',
                            'url' => '/backups',
                        ],
                        [
                            'text' => 'Restore',
                            'can' => 'ver listado restore',
                            'icon' => 'fas fa-address-card',
                            'url' => '/restore',
                        ],
                    ],
        ...
        [
            'text' => 'Publicación Anuncios',
            'can' => 'modulo anuncios',
            'icon' => 'fas fa-newspaper',
            'submenu' => [
                [
                    'text' => 'Gestionar Anuncios',
                    'can' => 'ver listado de anuncios',
