...
@section('content_header')
    <h1 class="m-0 text-dark">Administrador de Permisos</h1>
@stop
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalPurpleLabel">Nuevo Permiso</h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('permisos.store') }}" method="post">
                        @csrf
                        <div class="row">
                            <x-adminlte-input name="nombre" label="Nombre" placeholder="Aqui su permiso..." fgroup-class="col-md-6" disable-feedback/>
                        </div>
