                ...
                @foreach ($backups as $backup)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('backups.download', ['file_name' => $backup['file_name']]) }}" class="btn btn-primary btn-sm"><i class="fas fa-download"></i></a>
                            <form action="{{ route('backups.delete', ['file_name' => $backup['file_name']]) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('¿Está seguro de que desea eliminar este respaldo?')">
