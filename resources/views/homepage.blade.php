...
<body class="template-color-1 nft-body-connect">
    ...
    <div id="banner-area" class="slider-one rn-section-gapTop">
        <div class="container">
            <div class="row row-reverce-sm align-items-center">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12 offset-lg-1">
                    <div class="slider-thumbnail">
                        <img src="{{ asset('https://cdn.pixabay.com/photo/2016/12/20/05/36/store-1919731_960_720.png') }}"
                            alt="Slider Images">
                    </div>
                </div>
            </div>
    ...
    <div id="categoribanner"class="rn-new-items rn-section-gapTop">
        <div class="container">
                    ...
                    <div data-sal="slide-up" data-sal-delay="150" data-sal-duration="800"
                        ...
                        <div class="product-style-one no-overlay">
                            <div class="card-thumbnail">
                                <a >
                                    <img src="{{ $categoria->url }}" alt="NFT_portfolio">
                                </a>
                            </div>
                            <div class="product-share-wrapper">
                                <div class="profile-share">
                                    <a  class="avatar" data-tooltip="Jone lee">
                                        <img src="{{ asset('assets/images/client/client-1.png') }}"
                                            alt="Nft_Profile">
                                    </a>
                                    <a class="avatar" data-tooltip="Jone Due">
                                        <img src="{{ asset('assets/images/client/client-2.png') }}"
                                            alt="Nft_Profile">
                                    </a>
                                    <a  class="avatar" data-tooltip="Nisat Tara">
